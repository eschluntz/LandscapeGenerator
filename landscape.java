...
public float detail_small = .04f;
public float detail_big = .02f;
...
public float Sea_level = .4f;
public float Tree_line = .65f;
...
public void setup() 
{
  ...
  controlP5.addSlider("detail_small", 0, .1f).linebreak();
  controlP5.addSlider("detail_big", 0, .1f).linebreak();
...
public float flatten(float h)
{
  if (h < sea_level) h = sea_level;
  return h;
}

public void set_color(float h)
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "landscape" });
  }
}
